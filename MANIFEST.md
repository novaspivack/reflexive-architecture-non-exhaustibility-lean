...
| `ProvBicU123EnrichedR4Alignment.lean` | **SPEC_022_RA1** (**O7**): **`A_link_const`** (`ofConstant`) + **`A_link_dep`** (**`u123SemanticBarrierLink_provBicReprAugment`**, repr via **`augment_withGlobalConjunct`** + **`b.reprBarrier`**) → **`u123DrivenSync`** enriched **R₄** |
