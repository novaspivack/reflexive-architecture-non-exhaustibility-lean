...
| `ResidualDynamics.lean` | **EPIC_015 / SPEC_023_RG1 P0:** **`Identification`**, **`IsRefinementStep`**, **`PairSplitByRefinement`**, **`RegimeSnapshot`**, **`ResidualResponseStep`** (refinement vs reconfiguration); baby lemmas; **no** D0–D2 theorems yet |
