...
| `ResidualDynamics.lean` | **EPIC_015 / SPEC_023_RG1** + **SPEC_013_IC1** pattern: **`KernelOfMap`**, **`kernelWitness_of_map`**, **`d0_forgetfulKernel_notSeparated_of_still_fine`**, **`d0_forgetfulKernel_standing_fine`**; plus **P0**/`KernelWitness`/`d0_*`; **D1**–**D3** **open** |
