...
| `ResidualDynamics.lean` | **SPEC_023_RG1**: **D0**–**D1**; **`residualWitness_of_kernelWitness`**; **`d0_forgetfulKernel_obtains_admissible_r2_residual`** (**`α β : Type`**); **`forgetfulKernel_residual_r2_admissible_nontrivial_props`**; **`standingResidualBurden_*`**; **D2** / **R₄** upgrade **open** |
