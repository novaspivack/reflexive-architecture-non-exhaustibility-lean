...
| `Adequacy.lean` | **SPEC_012_AA1** + **SPEC_023_RG1 D3**: **`d3_adequacy_aftermath_standing_burden`**, **`d3_aftermath_standing_r4_admissible_core`**, **`d3_adequacy_aftermath_standing_burden_of_u123BarrierData`** / **`…_nonempty_u123_arch`** / **`…_regime_arch_eq_*`** (**`RegimeSnapshot`** + **`u123BarrierData_cast`**); **`CertificateWorldConsistent`**, **`honest_aftermath_carries_admissible_r4`**; imports **`ResidualDynamics`**, **`Interfaces`** |
