...
| `ResidualEnrichment/Bridges/FromNEMSProgramV.lean` | **D-001 / EPIC_012:** **`EngineNemsBarrierSync`**, **`ofConstantBarrier`**, **`ofSemanticSelfDescriptionFrame`**, **`ofSemanticSelfDescriptionFrame_barrierFromReflection`** (**`barrier_hypotheses_from_reflection`**), **`enrichedR4_*_semanticSync`**, **`enrichedR4_*_reflectionSync`**, **`trivialBarrier`**, sync promotion + **`certFn`** bridge |
