...
Lean anchors (in \texttt{reflective-fold-obstruction-lean}, imported transitively): \texttt{semanticType\_preorder\_nontrivial}, \texttt{typeReachable\_pullback\_iff\_of\_section}, \texttt{selfModelDepth\_obstruction}, \texttt{adjudication\_semantic\_obstruction}. No new \texttt{lake require} is needed in this program; the machinery is available via the existing RFO dependency.
